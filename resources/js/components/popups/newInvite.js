                    ...
                    <div className="popup">
                        ...
                        <div className="popup-content">
                            ...
                            >
                                ...
                                <div className={this.state.updated ? "alert alert-green center-text" : "hidden"}>{this.state.updated_message}</div>
                                    ...
                                    <TabPanel tabId="one">
                                        <div className="row">
                                            ...
                                            <div className="six columns">
                                                ...
                                                <input type="text" onChange={e => this.setState({ user_lastname: e.target.value })}/>
                                            </div>
                                        </div>
                                        <div className="row">
                                            <div className="six columns">
                                            ...
                                            <div className="six columns">
                                                ...
                                                <input type="text" onChange={e => this.setState({ user_function: e.target.value })} />
                                            </div>
                                        </div>
                                        <h5>Password</h5>
                                        <div className="row">
                                            ...
                                            <div className="six columns">
                                                ...
                                                <input type="password" className="u-full-width" onChange={e => this.setState({ password_retype: e.target.value })} />
                                            </div>
                                        </div>
                                    </TabPanel>
                                    <TabPanel tabId="two">
                        ...
                        <div className={this.state.isLoading ? "popup-loading" : "hidden"}>
                            <h5>Setting everything ready ...</h5>
