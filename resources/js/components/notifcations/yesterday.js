...
export default class NotificationsYesterday extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <span className={this.state.notifications.length === 0 ? "hidden" : "dashboard-notifications--day"}>YESTERDAY</span>
...
if (document.getElementById('notifications-yesterday')) {
    ReactDOM.render(<NotificationsYesterday />, document.getElementById('notifications-yesterday'));
}
